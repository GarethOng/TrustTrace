          ...
          >
            ...
            <Box sx={{ backgroundColor: '#e0f0ff', padding: '8px' }}>
              ...
              <Typography
                variant='span'
                sx={{ fontWeight: 'bold' }}
              >{`$1M for emergency medical aid,`}</Typography>
          ...
          >
            ...
            <Box sx={{ backgroundColor: '#e0f0ff', padding: '8px' }}>
              <Box>
                ...
                >{`Total Amount: $1,000,000`}</Typography>
                ...
                >{`Category 1: Emergency Medicine - $400,000 (40%)`}</Typography>
                <Typography
                  sx={{ fontFamily: 'Cabin', marginLeft: '8px' }}
                >{`- 0x4Q438ML9UKK1872LW2HXVA1FSTIBXV (North City Hospital)`}</Typography>
                <Typography
                  sx={{ fontFamily: 'Cabin', marginLeft: '8px' }}
                >{`- 0xW0QY0CCVC601QZIP9CO1JMWGL1YK3T (Central National Hospital)`}</Typography>
                <Typography
                  sx={{ fontFamily: 'Cabin', marginLeft: '8px' }}
                >{`- 0xG1PNQ5SER1UE3KRTSY7F9GZIVMAWXX (Clinics Administration)`}</Typography>
                ...
                >{`Category 2: Clean Water and Purifiers - $400,000 (40%)`}</Typography>
                <Typography
                  sx={{ fontFamily: 'Cabin', marginLeft: '8px' }}
                >{`- 0x4Q438ML9UKK1872LW2HXVA1FSTIBXV (North City Hospital)`}</Typography>
                <Typography
                  sx={{ fontFamily: 'Cabin', marginLeft: '8px' }}
                >{`- 0xAJQVTWI6TB3F0U7ICU4WMLXJBTMMR5 (Waterworks Inc.)`}</Typography>
                <Typography
                  sx={{ fontFamily: 'Cabin', marginLeft: '8px' }}
                >{`- 0x8AGXCQOORSTREBDDPRB96JEVMTFCTD (BigBottle Water Inc.)`}</Typography>
                ...
                >{`Category 3: Manpower - $200,000 (20%)`}</Typography>
                <Typography
                  sx={{ fontFamily: 'Cabin', marginLeft: '8px' }}
                >{`- 0xSRE7BIXNDCCDZIO3GROJ9DTUGD1WPT (Northern District Recruiment Center)`}</Typography>
                <Typography
                  sx={{ fontFamily: 'Cabin', marginLeft: '8px' }}
                >{`- 0xF1ESNNLMB6M6Z5IQE3FUVTQRIVX1E1 (Charity Operations Team)`}</Typography>
              </Box>
            </Box>
          </Box>
        </Box>
